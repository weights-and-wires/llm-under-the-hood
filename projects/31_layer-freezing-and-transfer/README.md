...
python projects/31_layer-freezing-and-transfer/build.py --tiny

# Full lab (requires hardware — see setup/03_gpu-and-hardware-tiers.md):
python projects/31_layer-freezing-and-transfer/build.py --full

# The BREAK IT experiment:
python projects/31_layer-freezing-and-transfer/break_it.py
```
