...
python projects/34_the-interface-specification/build.py --tiny

# Full lab (requires hardware — see setup/03_gpu-and-hardware-tiers.md):
python projects/34_the-interface-specification/build.py --full

# The BREAK IT experiment:
python projects/34_the-interface-specification/break_it.py
```
